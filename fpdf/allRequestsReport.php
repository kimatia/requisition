...
$date=date("jS M Y" );
 $requests="SELECT * FROM requests WHERE status='approved' OR status='ordered' OR status='paused' OR status= 'finalapproved' OR status= 'finalflagged' OR status= 'finalrejected' ORDER BY request_date DESC";
...
//writable horizontal: 219 -(10*2)=189
 ...
 $pdf->Cell(59,5,"ALL REQUESTS",0,1); //end of line
 ...
 $pdf->Cell(25,5,$rows['faculty'],1,0,"R");
