...
$date=date("jS M Y" );
 $requests="SELECT * FROM orders WHERE status= 'delivered' ";
...
//writable horizontal: 219 -(10*2)=189
 ...
 $pdf->Cell(59,5," DELIVERED ORDERS",0,1); //end of line
 ...
 $pdf->Cell(35,5,$rows['order_no'],1,0);
 $pdf->Cell(75,5,$rows['items'],1,0);
 $pdf->Cell(45,5,$rows['description'],1,0);
